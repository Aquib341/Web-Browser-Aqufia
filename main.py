...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        #url = http://www.google.com and others,
        #label = Homepage
        self.add_new_tab(QUrl('http://www.Bing.com'), 'Homepage')
        self.add_new_tab(QUrl('http://www.yahoo.com'), 'Homepage')
        self.add_new_tab(QUrl('http://www.DuckDuckGo.com'), 'Homepage')
        self.add_new_tab(QUrl('http://www.Google.com'), 'Homepage')
        self.add_new_tab(QUrl('http://www.Youtube.com'), 'Homepage')
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("https://mid.rahul.ac.in/web/"))
...
app.setApplicationName("AquFia")
app.setOrganizationName("A&R Company")
app.setOrganizationDomain("AquFia.org")
